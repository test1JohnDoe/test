...
<div class="container">
    <div class="add-article-wrapper">
        ...
        <footer>
            <h3>Edit Post</h3>
            <form action="/?route=edit_post" id="article" method="post">
                Title: <input type="text" name="title" value="<?=$viewData->getTitle()?>"><br>
                Text: <input type="text" name="text" value="<?=$viewData->getText()?>"><br>
                <input type="hidden" name="postId" value="<?=$viewData->getId()?>">
                <input type="submit">
            </form>
        </footer>
    </div>
